...
(function(global, factory) {
  ...
  */
  ...
  const IPFMenuBar = ({
    openActivityLog: openActivityLog2
  }) => {
    require$$0.useState(0);
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [/* @__PURE__ */ jsx("hr", {}), /* @__PURE__ */ jsxs("div", {
        className: "center",
        children: [/* @__PURE__ */ jsx("span", {
          className: "color-grey",
          children: "Idle Pixel Fixed"
        }), /* @__PURE__ */ jsxs("div", {
          className: "App",
          children: [/* @__PURE__ */ jsx("br", {}), /* @__PURE__ */ jsx("p", {
            children: /* @__PURE__ */ jsx("button", {
              type: "button",
              onClick: openActivityLog2,
  ...
  const LootEntry = ({
    ...
    return /* @__PURE__ */ jsxs("div", {
      ...
      }), content.items.map((item) => /* @__PURE__ */ jsx("div", {
        children: item.label
      }))]
    });
  };
  ...
  const ActivityLog = ({
    open,
    closeActivityLog: closeActivityLog2
  }) => {
    ...
    return /* @__PURE__ */ jsx(Fragment, {
      children: open && /* @__PURE__ */ jsxs("div", {
        ...
        children: [/* @__PURE__ */ jsx("h2", {
          className: "color-grey",
          children: "Activity log"
        }), list.map((item) => /* @__PURE__ */ jsx(ActivityLogEntry, {
          item
        })), /* @__PURE__ */ jsx("button", {
          type: "button",
          onClick: closeActivityLog2,
          children: "Close"
        })]
      })
    });
  ...
  (function(exports2) {
    ...
    exports2.unstable_scheduleCallback = function(a, b, c) {
      ...
      c > d ? (a.sortIndex = c, H2(M2, a), J(L) === null && a === J(M2) && (S2 ? h2() : S2 = true, g2(U2, c - d))) : (a.sortIndex = e, H2(L, a), R2 || Q || (R2 = true, f2(V2)));
      return a;
    };
   ...
   * LICENSE file in the root directory of this source tree.
   */
  var aa = require$$0__default["default"], m = objectAssign, r = scheduler.exports;
  function y(a) {
    ...
    Nb(function() {
      ...
      a: {
        ...
        if (h3 !== void 0) {
          ...
          var w = (b & 4) !== 0, z = !w && a === "scroll", u = w ? h3 !== null ? h3 + "Capture" : null : h3;
          w = [];
          ...
          0 < w.length && (h3 = new k2(h3, x, null, c, e2), g3.push({ event: h3, listeners: w }));
        }
      }
      if ((b & 7) === 0) {
        a: {
          ...
          if (h3 && (b & 16) === 0 && (x = c.relatedTarget || c.fromElement) && (wc(x) || x[ff]))
            break a;
          if (k2 || h3) {
        ...
        a: {
          ...
          if (k2 === "select" || k2 === "input" && h3.type === "file")
            ...
            (k2 = h3.nodeName) && k2.toLowerCase() === "input" && (h3.type === "checkbox" || h3.type === "radio") && (J = Ee);
          if (J && (J = J(a, d2))) {
            ne(g3, J, c, e2);
            break a;
          }
  ...
  function hf(a, b, c, d, e) {
    for (var f2 = b._reactName, g2 = []; c !== null && c !== d; ) {
      ...
      if (k !== null && k === d)
        break;
      h2.tag === 5 && l !== null && (h2 = l, e ? (k = Ob(c, f2), k != null && g2.unshift(ef(c, k, h2))) : e || (k = Ob(c, f2), k != null && g2.push(ef(c, k, h2))));
      c = c.return;
    }
        ...
        if ((d & h2) === h2) {
          ...
          a: {
            ...
            switch (x.tag) {
              ...
              case 0:
                C = x.payload;
                h2 = typeof C === "function" ? C.call(p2, A, h2) : C;
          ...
          p2 = { eventTime: p2, lane: h2, tag: f2.tag, payload: f2.payload, callback: f2.callback, next: null }, n2 === null ? (l = n2 = p2, k = A) : n2 = n2.next = p2, g2 |= h2;
        f2 = f2.next;
        if (f2 === null)
  ...
  function Sg(a) {
    ...
    function x(e2, g3, h3, k2) {
      for (var l2 = null, t = null, u = g3, z = g3 = 0, q2 = null; u !== null && z < h3.length; z++) {
        u.index > z ? (q2 = u, u = null) : q2 = u.sibling;
        var n3 = p2(e2, u, h3[z], k2);
        if (n3 === null) {
          u === null && (u = q2);
          break;
        }
      ...
      if (u === null) {
        for (; z < h3.length; z++)
          u = A(e2, h3[z], k2), u !== null && (g3 = f2(u, g3, z), t === null ? l2 = u : t.sibling = u, t = u);
        return l2;
      }
      for (u = d(e2, u); z < h3.length; z++)
        q2 = C(u, e2, z, h3[z], k2), q2 !== null && (a && q2.alternate !== null && u.delete(q2.key === null ? z : q2.key), g3 = f2(q2, g3, z), t === null ? l2 = q2 : t.sibling = q2, t = q2);
      a && u.forEach(function(a2) {
        return b(e2, a2);
      });
      return l2;
    }
    function w(e2, g3, h3, k2) {
      var l2 = La(h3);
      ...
      if (h3 == null)
        throw Error(y(151));
      for (var t = l2 = null, u = g3, z = g3 = 0, q2 = null, n3 = h3.next(); u !== null && !n3.done; z++, n3 = h3.next()) {
        u.index > z ? (q2 = u, u = null) : q2 = u.sibling;
    ...
    return function(a2, d2, f3, h3) {
      ...
      if (Pg(f3))
        return x(a2, d2, f3, h3);
      if (La(f3))
        return w(a2, d2, f3, h3);
      l2 && Rg(a2, f3);
  ...
  function pi(a, b, c, d, e) {
    ...
    if (b.stateNode === null)
      ...
      A || typeof g2.UNSAFE_componentWillReceiveProps !== "function" && typeof g2.componentWillReceiveProps !== "function" || (h2 !== d || k !== l) && Ng(b, g2, d, l);
      wg = false;
      var p2 = b.memoizedState;
      g2.state = p2;
      Cg(b, d, g2, e);
      k = b.memoizedState;
      h2 !== d || p2 !== k || N.current || wg ? (typeof n2 === "function" && (Gg(b, c, n2, d), k = b.memoizedState), (h2 = wg || Lg(b, c, h2, d, p2, k, l)) ? (A || typeof g2.UNSAFE_componentWillMount !== "function" && typeof g2.componentWillMount !== "function" || (typeof g2.componentWillMount === "function" && g2.componentWillMount(), typeof g2.UNSAFE_componentWillMount === "function" && g2.UNSAFE_componentWillMount()), typeof g2.componentDidMount === "function" && (b.flags |= 4)) : (typeof g2.componentDidMount === "function" && (b.flags |= 4), b.memoizedProps = d, b.memoizedState = k), g2.props = d, g2.state = k, g2.context = l, d = h2) : (typeof g2.componentDidMount === "function" && (b.flags |= 4), d = false);
    } else {
      g2 = b.stateNode;
      yg(a, b);
      h2 = b.memoizedProps;
      ...
      for (l in d) {
        ...
        if (d.hasOwnProperty(l) && k !== h2 && (k != null || h2 != null))
          if (l === "style")
            ...
            l === "dangerouslySetInnerHTML" ? (k = k ? k.__html : void 0, h2 = h2 ? h2.__html : void 0, k != null && h2 !== k && (f2 = f2 || []).push(l, k)) : l === "children" ? typeof k !== "string" && typeof k !== "number" || (f2 = f2 || []).push(l, "" + k) : l !== "suppressContentEditableWarning" && l !== "suppressHydrationWarning" && (ca.hasOwnProperty(l) ? (k != null && l === "onScroll" && G("scroll", a), f2 || h2 === k || (f2 = [])) : typeof k === "object" && k !== null && k.$$typeof === Ga ? k.toString() : (f2 = f2 || []).push(l, k));
      }
  ...
  function Mj(a, b) {
    for (var c = a.callbackNode, d = a.suspendedLanes, e = a.pingedLanes, f2 = a.expirationTimes, g2 = a.pendingLanes; 0 < g2; ) {
      var h2 = 31 - Vc(g2), k = 1 << h2, l = f2[h2];
      if (l === -1) {
        if ((k & d) === 0 || (k & e) !== 0) {
          l = b;
          Rc(k);
          var n2 = F;
          f2[h2] = 10 <= n2 ? l + 250 : 6 <= n2 ? l + 5e3 : -1;
        }
      } else
    ...
    if (d !== null) {
      ...
      if (Oe(g2)) {
        if ("selectionStart" in g2)
          ...
          a:
            if (h2 = (h2 = g2.ownerDocument) && h2.defaultView || window, (l = h2.getSelection && h2.getSelection()) && l.rangeCount !== 0) {
              h2 = l.anchorNode;
              f2 = l.anchorOffset;
              k = l.focusNode;
              l = l.focusOffset;
              ...
              b:
                for (; ; ) {
                  for (var u; ; ) {
                    w !== h2 || f2 !== 0 && w.nodeType !== 3 || (A = n2 + f2);
              ...
              h2 = A === -1 || p2 === -1 ? null : { start: A, end: p2 };
            } else
              h2 = null;
        h2 = h2 || { start: 0, end: 0 };
      } else
      ...
      if (q2 !== t && t && t.ownerDocument && Me(t.ownerDocument.documentElement, t)) {
        g2 !== null && Oe(t) && (q2 = g2.start, v = g2.end, v === void 0 && (v = q2), "selectionStart" in t ? (t.selectionStart = q2, t.selectionEnd = Math.min(v, t.value.length)) : (v = (q2 = t.ownerDocument || document) && q2.defaultView || window, v.getSelection && (v = v.getSelection(), h2 = t.textContent.length, J = Math.min(g2.start, h2), g2 = g2.end === void 0 ? J : Math.min(g2.end, h2), !v.extend && J > g2 && (h2 = g2, g2 = J, J = h2), h2 = Le(t, J), f2 = Le(t, g2), h2 && f2 && (v.rangeCount !== 1 || v.anchorNode !== h2.node || v.anchorOffset !== h2.offset || v.focusNode !== f2.node || v.focusOffset !== f2.offset) && (q2 = q2.createRange(), q2.setStart(h2.node, h2.offset), v.removeAllRanges(), J > g2 ? (v.addRange(q2), v.extend(f2.node, f2.offset)) : (q2.setEnd(f2.node, f2.offset), v.addRange(q2))))));
        q2 = [];
  ...
  const appendReact = (component, id2, insertBeforeId) => {
    ...
    ReactDOM.render(/* @__PURE__ */ jsx(require$$0__default["default"].StrictMode, {
      children: component
    }), document.getElementById(reactRootId));
  };
  let [activityLogOpen, setActivityLogOpen] = require$$0.useState(false);
  const openActivityLog = () => setActivityLogOpen(true);
  const closeActivityLog = () => setActivityLogOpen(false);
  appendReact(/* @__PURE__ */ jsx(IPFMenuBar, {
    openActivityLog
  }), "menu-bar-buttons");
  appendReact(/* @__PURE__ */ jsx(ActivityLog, {
